...
public class MemberServiceAdvice {
    ...
    @Pointcut("execution(* wjdwo1104.hello.spring4.controller.MemberController.myinfo(..))")
    public void myInfoPoint() {}

    @Pointcut("execution(* wjdwo1104.hello.spring4.controller.MemberController.join(..))")
